            ...
            <div className={cn(
                ...
                <div className="max-w-7xl mx-auto px-6 py-4">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-xl font-bold tracking-tight text-slate-900 dark:text-white">Add New Address</h1>
                            <p className="text-sm text-slate-500">Create a new address for your organization</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="hidden lg:block w-80 shrink-0 sticky top-28 space-y-6">
                        <div className="bg-blue-50 dark:bg-blue-900/20 rounded-2xl p-6 border border-blue-100 dark:border-blue-900/50">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <h4 className="font-semibold text-blue-900 dark:text-blue-100 text-sm">Address Types</h4>
                                    <p className="text-sm text-blue-700 dark:text-blue-300 mt-1 leading-relaxed">
                                        Use 'Head Office' for your main registration and 'Branch' for regional locations. This affects filtered views.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-amber-50 dark:bg-amber-900/20 rounded-2xl p-6 border border-amber-100 dark:border-amber-900/50">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <h4 className="font-semibold text-amber-900 dark:text-amber-100 text-sm">State Selection</h4>
                                    <p className="text-sm text-amber-700 dark:text-amber-300 mt-1 leading-relaxed">
                                        Currently optimized for Indian states. For international addresses, select 'Other' in Country to input state manually.
                                    </p>
                                </div>
                            </div>
                        </div>
