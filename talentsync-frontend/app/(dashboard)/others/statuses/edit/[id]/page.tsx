...
import { useStatuses, saveStatus } from "../../store";
...
export default function EditStatusPage({ params }: { params: { id: string } }) {
    ...
    const existingStatus = statuses.find(s => s.id === params.id);
    ...
    useEffect(() => {
        if (existingStatus) {
            form.reset({
                ...
                interviewStage: existingStatus.interviewStage,
            });
        }
    }, [existingStatus, form]);
    ...
    if (!existingStatus && statuses.length > 0) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[50vh]">
                <h2 className="text-2xl font-bold mb-4">Status Not Found</h2>
            ...
            <div className={cn(
                ...
                <div className="max-w-7xl mx-auto px-6 py-4">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-xl font-bold tracking-tight text-slate-900 dark:text-white">Edit Status</h1>
                            <p className="text-sm text-slate-500">Update existing pipeline stage</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-border/50 shadow-sm overflow-hidden p-6 md:p-8">
                            <div className="flex items-center gap-3 mb-6 pb-4 border-b border-border/50">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">Edit the status properties</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-blue-700 dark:text-blue-300 mt-1 leading-relaxed">
                                        Updated statuses will immediately apply to all candidates currently in this stage.
                                    </p>
                                </div>
                            </div>
                        </div>
